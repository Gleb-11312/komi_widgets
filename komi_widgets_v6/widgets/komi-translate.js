...
;(function(){
  ...
  async function mount(target, opts){
    ...
    el.innerHTML = `
      ...
      <div class="komi-card">
        <div class="komi-title">Komi Translator (beta)</div>
        <div class="komi-muted" style="margin:.25rem 0">This translator converts text from <b>English to Komi</b> (via Russian). It’s still in development, so some words may be missing or imperfectly translated.</div>
